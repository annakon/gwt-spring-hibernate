...
public class InputAndLabel extends ButtonBase implements HasName, HasValue<String>, HasChangeHandlers {
     ...
     */
    public InputAndLabel(String label, String placeholder) {
        this();
        setText(label);
     ...
     */
    public InputAndLabel(String label, boolean asHTML) {
        this();
        if (asHTML) {
            setHTML(label);
        } else {
    ...
    protected InputAndLabel(Element elem) {
        ...
        inputElem.setClassName("form-control");
        ...
        if (!valueChangeHandlerInitialized) {
            addChangeHandler(new ChangeHandler() {
                public void onChange(ChangeEvent event) {
                    ValueChangeEvent.fire(InputAndLabel.this, getValue());
                }
            });
